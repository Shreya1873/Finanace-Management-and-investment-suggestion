...
class HomePage:
    def __init__(self, table_name):
        ...
        self.saving_button = Button(cursor="hand2", image=black_button_image,bg="black", text="Saving Suggestions", fg="white", font=("Arial", 15, "bold"), height=105, width=220, highlightthickness=0, compound="center", command=self.saving_pressed)
        self.saving_button.place(x=610, y=0)
        ...
        self.expense_button = Button(cursor="hand2", image=green_button_image, text="+  Expense", width=154, height=40, compound="center", fg="white", font=("Arial", 15, "bold"), highlightthickness=0, command=self.expense_pressed)
        self.expense_button.place(x=574, y=535)

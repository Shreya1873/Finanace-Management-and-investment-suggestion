...
def bar(bargraph):
    ...
    axes.bar(range(len(bargraph)),[N[1] for N in bargraph],tick_label=[N[0] for N in bargraph], width=0.4, alpha=0.7,linewidth=0.3,edgecolor="black",facecolor="hotpink")

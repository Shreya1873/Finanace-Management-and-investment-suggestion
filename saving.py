...
class Saving_table:
    ...
    def make_saving_table(self):
        ...
        self.saving_table = ttk.Treeview(self.Table_Frame, column=("id", "sn", "tenure", "mi", "ir", "return"))
        ...
        self.saving_table.column("id", width=35, anchor="center",minwidth=35)
        self.saving_table.column("sn", width=315, anchor="center",minwidth=315)
        self.saving_table.column("tenure", width=130, anchor="center",minwidth=130)
        self.saving_table.column("mi", width=175, anchor="center",minwidth=175)
        self.saving_table.column("ir", width=130, anchor="center",minwidth=130)
        self.saving_table.column("return", width=65, anchor="center",minwidth=65)

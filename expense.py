...
class Expense:
    def __init__(self, table_name):
        ...
        self.date_label = self.canvas.create_text(360, 185, fill="white", text="Date        : ", font=("Arial", 17, "bold"))
        self.amount_label = self.canvas.create_text(360, 255, fill="white", text="Amount   : ", font=("Arial", 17, "bold"))
        ...
        self.category_combobox.place(x=440, y=317)

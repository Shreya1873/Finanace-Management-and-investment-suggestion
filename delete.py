...
class Delete:
    ...
    def make_delete_table(self):
        ...
        self.Transaction_table.column("id", width=100,anchor="center",minwidth=100)
        self.Transaction_table.column("date", width=100,anchor="center",minwidth=100)
        self.Transaction_table.column("category", width=100,anchor="center",minwidth=100)
        self.Transaction_table.column("amount", width=100,anchor="center",minwidth=100)
        self.Transaction_table.column("balance", width=100,anchor="center",minwidth=100)
        self.Transaction_table.column("income", width=100,anchor="center",minwidth=100)
